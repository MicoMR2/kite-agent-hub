defmodule KiteAgentHub.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind kite_agent_hub", "esbuild kite_agent_hub"],
      "assets.deploy": [
        "tailwind kite_agent_hub --minify",
        "esbuild kite_agent_hub --minify",
        "phx.digest"
      ],
