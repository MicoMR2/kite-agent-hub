defmodule KiteAgentHub.Workers.TradeExecutionWorker do
  ...
  defp format_failure_reason(reason) when is_binary(reason), do: String.slice(reason, 0, 250)
  defp format_failure_reason(reason), do: reason |> inspect() |> String.slice(0, 250)
