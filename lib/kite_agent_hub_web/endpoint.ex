defmodule KiteAgentHubWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_kite_agent_hub_key",
    signing_salt: "Kkn4m1PN",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    ...
    only: KiteAgentHubWeb.static_paths(),
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :kite_agent_hub
  end
