defmodule KiteAgentHubWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: KiteAgentHubWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KiteAgentHubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KiteAgentHubWeb.Gettext, "errors", msg, opts)
    end
  end
