defmodule KiteAgentHubWeb.UserAuth do
  ...
  def on_mount(:require_admin, _params, session, socket) do
    ...
    cond do
      ...
      KiteAgentHub.Accounts.Invites.admin?(user) ->
        {:cont, socket}
  ...
  @remember_me_cookie "_kite_agent_hub_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      KiteAgentHubWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
